...
@section('title', 'Withdraw Money | Vendor')
                    ...
                    <div class="breadcrumbs">
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item active">
                                    <a class="breadcrumbs__link" href="{{ route("vendors.finances.withdraw") }}">
                                        <span>Withdraw </span>
                                    </a>
                                </li>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            withdrawButton.addEventListener('click', function () {
                ...
                fetch("{{ route('vendors.finances.withdrawCash') }}", {
                    method: 'POST',
                    headers: {
                ...
                .then(result => {
                    ...
                    setTimeout(function () {
                        window.location.href = "{{ route('vendors.finances.index') }}";
