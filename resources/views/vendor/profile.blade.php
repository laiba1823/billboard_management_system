                        ...
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item active">
                                    <a class="breadcrumbs__link" href="{{ route('vendors.profile') }}">
                                        <span>Profile</span>
                                    </a>
                                </li>
                        ...
                        <div class="card__container">
                            ...
                            <div class="card__header">
                                <div class="card__header-left">
                                    <h3 class="card__header-title">Vendor Info</h3>
                                </div>
                            ...
                            <div class="card__body">
                                ...
                                <div class="customer-profile__avatar" style="overflow: hidden">
                                    <img src="{{ asset($vendor->img) }}"
                                         alt=""
                                         style="border-radius: 10px;height: -webkit-fill-available;">
                                </div>

                                <h4 class="customer-profile__title">{{ $vendor->name }}</h4>

                                <div class="input-group input-group--white input-group--prepend">
                                    <div class="input-group__prepend">
                                        <i class="fa-solid fa-lock"></i>
                                    </div>
                                    <input class="input" type="password" value="1234567890" disabled>
                                </div>
                                ...
                                <div class="card__credit-card">
                                    <div class="credit-card">
                                        ...
                                        <img class="credit-card__image"
                                             src="{{ asset('img/content/credit-card%403x.png') }}"
                                             alt="#">

                                        <div class="credit-card__content">

                                            <input class="credit-card__number" type="text"
                                                   value="{{ optional($bankAccount)->card_number ?? '-' }}"
                                                   readonly>

                                            <div class="credit-card__name">
                                                {{ optional($bankAccount)->card_holder ?? '-' }}
                                            </div>

                                            <div class="credit-card__date">
                                                {{ optional($bankAccount)->card_expiry ?? '-' }}
                                            </div>
                                ...
                                <div class="modal__wrap">
                                    <div class="modal__window">
                                        <div class="modal__content">
                                            ...
                                            <form method="POST" action="{{ route("vendors.update", $vendor->id) }}" id="infoForm" enctype="multipart/form-data">
                                                @csrf
                                                @method("PUT")
                                                <div class="modal__body">
                                                    <div class="modal__container">
                                                        <div class="modal-account__upload profile-upload js-profile-upload">
                                                            ...
                                                            <svg class="profile-upload__thumbnail" viewBox="0 0 252 272" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                                ...
                                                                <defs>
                                                                    ...
                                                                    <image id="profileImageAddPlaceholder" width="700" height="700" xlink:href="  {{ asset($vendor->img ) }}"></image>
                                                                    <image id="profileImageAdd" class="profile-upload__image" width="700" height="700" xlink:href="{{ asset($vendor->img ) }}"></image>
                                                                </defs>
                                                            </svg>
                                                        ...
                                                        <div class="space-upNdown input-group input-group--white input-group--prepend">
                                                            ...
                                                            <input class="input" type="text" name="name" value="{{ $vendor->name }}" placeholder="Name">
                                                        </div>
                                                        ...
                                                        <div class=" space-upNdown input-group input-group--white input-group--prepend">
                                                            ...
                                                            <input class="input" type="email" name="email" value="{{$vendor->email }}" placeholder="Email" >
                                                        </div>
                            ...
                            <div class="simplebar-content" style="padding: 0px;">
                                ...
                                <div class="modal__wrap">
                                    <div class="modal__window">
                                        <div class="modal__content">
                                            <div class="modal__body">
                                                <form id="bankAccountForm" action="{{ route("vendors.bank_account.update", ['id' => $vendor->id]) }}" method="POST">
                                                    @method("PUT")
                                                    @csrf
