							...
							<div class="col-12 col-sm-12 col-md-12 col-lg-3 float-left">
								<div class="row">
									<div class="wt-userprofile">
										<figure>
											<img src="{{ asset($vendor->img) }}" alt="img description">
											<div class="wt-userdropdown wt-online">
											</div>
										</figure>
										<div class="wt-title">
											<h3><i class="fa fa-check-circle"></i> Verified</h3>
											<span>5.0/5 <a class="javascript:void(0);">(860 Feedback)</a> <br>Member since {{ \Carbon\Carbon::parse($vendor->created_at)->format('jS F Y') }} <br>
							...
							<div class="col-12 col-sm-12 col-md-12 col-lg-9 float-left">
								<div class="row">
									...
									<div id="wt-statistics" class="wt-statistics wt-profilecounter">
										...
										<div class="wt-description">
											<p>* Addify's is not resposible if someone scams you</p>
