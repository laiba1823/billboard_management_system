                        ...
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item active">
                                    <a class="breadcrumbs__link" href="{{ route('buyers.profile') }}">
                                        <span>Profile</span>
                                    </a>
                                </li>
                        ...
                        <div class="card__container">
                            <div class="card__header">
                                <div class="card__header-left">
                                    <h3 class="card__header-title">Buyer Info</h3>
                                </div>
                            ...
                            <div class="card__body">
                                ...
                                <h4 class="customer-profile__title">{{ $buyer->name }}</h4>
                                ...
                                <div class="card__container">
                                    <ul class="customer-profile__address">
                                        <li>
                                            ...
                                            </svg> <a href="mailto:#">{{ $buyer->email }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="modal__wrap">
                                    <div class="modal__window">
                                        <div class="modal__content">
                                            ...
                                            <form method="POST" action="{{ route("buyers.update", $buyer->id) }}" id="infoForm" enctype="multipart/form-data">
                                                @csrf
                                                @method("PUT")
                                                <div class="modal__body">
                                                    <div class="modal__container">
                                                        ...
                                                        <div class="space-upNdown input-group input-group--white input-group--prepend">
                                                            ...
                                                            <input class="input" type="text" name="name" value="{{ $buyer->name }}" placeholder="Name">
                                                        </div>
                                                        ...
                                                        <div class=" space-upNdown input-group input-group--white input-group--prepend">
                                                            ...
                                                            <input class="input" type="email" name="email" value="{{$buyer->email }}" placeholder="Email" >
                                                        </div>
                            ...
                            <div class="simplebar-content" style="padding: 0px;">
                                ...
                                <div class="modal__wrap">
                                    <div class="modal__window">
                                        <div class="modal__content">
                                            <div class="modal__body">
                                                <form id="bankAccountForm" action="{{ route("buyers.bank_account.update", ['id' => $buyer->id]) }}" method="POST">
                                                    @method("PUT")
                                                    @csrf
