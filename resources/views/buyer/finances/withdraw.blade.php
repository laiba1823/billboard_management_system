...
@section('title', 'Withdraw Money | Buyer')
                    ...
                    <div class="breadcrumbs">
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item active">
                                    <a class="breadcrumbs__link" href="{{ route("buyers.finances.withdraw") }}">
                                        <span>Withdraw </span>
                                    </a>
                                </li>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            withdrawButton.addEventListener('click', function () {
                ...
                fetch("{{ route('buyers.finances.withdrawCash') }}", {
                    method: 'POST',
                    headers: {
                ...
                .then(result => {
                    ...
                    setTimeout(function () {
                        window.location.href = "{{ route('buyers.finances.index') }}";
