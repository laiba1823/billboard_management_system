                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="wt-footerlogohold">
                        <strong class="wt-logo">
                            {{-- <a href="{{ route("public.home") }}"><img src="{{asset("img/content/logo-light.svg")}}" alt="buyer logo here"></a>s --}}
                        </strong>
                        <div class="wt-description">
                            <p>Addify's mission is to change how marketing works. Addify connects businesses with vendors offering billboards in 10+ locations.</p>
                        </div>
